// app/login/page.tsx - Updated with Firebase lazy loading and HeroSection
'use client';
...
export default function Login() {
  ...
  return (
    <>
      {/* HeroSection for Login page */}
      <HeroSection
        gradient="linear-gradient(to bottom, rgba(40, 60, 80, 0.4), rgba(40, 60, 80, 0.6))"
      ...
      >
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>
            Sign in to access your account and manage your trips
          </p>
        </div>
      </HeroSection>
      
      {/* .page container for the login form */}
